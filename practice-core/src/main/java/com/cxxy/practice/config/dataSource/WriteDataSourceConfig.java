package com.cxxy.practice.config.dataSource;
 ...
 * Author:liuhui
 * Description:
 * Date: 下午2:18 2017/12/21
 */
@Configuration
@EnableJpaRepositories(value = "com.cxxy.practice.repository",entityManagerFactoryRef = "writeEntityManagerFactory",
...
public class WriteDataSourceConfig {
    ...
    public EntityManagerFactory writeEntityManagerFactory() {
        ...
        factory.setPackagesToScan("com.cxxy.practice.bean");
